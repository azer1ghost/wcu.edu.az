<div class="page">
    ...
    <div class="page-container">
        ...
        if(!empty($this->post['photo'][0])){
            ?><img class="page-img third-fixed" src="<?=UPLOAD_DIR_LINK?>Image/englishprograms/<?=$this->post['photo'][0]['photo']?>" alt=""><?php
        }
        ?>
                ...
                <div>
                    ...
                    if(!empty($this->post['photo'])){
                        ...
                        foreach ($this->post['photo'] as $value){
                            if($x>1){
                                ?>
                                <a href="<?=UPLOAD_DIR_LINK?>Image/englishprograms/<?=$value['photo']?>" data-fancybox="gallery">
                                    <img src="<?=UPLOAD_DIR_LINK?>Image/englishprograms/<?=$value['thumb']?>" width="164" alt="gallery">
                                </a>
                                <?php
                            }
                            $x++;
