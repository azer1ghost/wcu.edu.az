...
class MFAdmin {
    ...
    public static $_menu_icon = [
        ...
        'galleries' => 'glyphicon-picture',
        'mainpage' => 'glyphicon-home',
    ];
    ...
    public static $_langs = ['az' => 'AZ', 'ru' => 'RU', 'en' => 'EN'];
    ...
    public function init() {
        ...
        if (empty($this->_url[0])) {
            ...
            self::$_lang = ( array_key_exists(htmlspecialchars(Session::get('lang')), self::$_langs) )?Session::get('lang'):$this->_defaultLang;
        }
    ...
    private function _loadExistingController() {
        ...
        // menus list
        $menus = Func::arrayFlatten(MFAdmin::$_menu_list);
