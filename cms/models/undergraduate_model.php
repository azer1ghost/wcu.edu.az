...
class Undergraduate_Model extends Model {
    public $_menu;

    public function __construct() {
        parent::__construct();

        $this->_menu = 'undergraduate';
    }
    ...
    public function createItem() {
        ...
        $data['data_code'] = isset($_POST['data_code']) ? Func::check($_POST['data_code']): 0;
    ...
    public function singleItem($id) {
        ...
        $query = "SELECT P.`id`, P.`parent`, P.`code`, P.`price`, P.`price_foreign`, P.`post_in_page`, P.`ordering`, P.`status`,  
                          T.`title`, T.`slug`, T.`type`, T.`text`, T.`lang`
                    FROM `cms_undergraduate` P
