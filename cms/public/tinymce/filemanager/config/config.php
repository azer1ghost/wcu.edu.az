...
$upload_dir = '/upload/Image/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../upload/Image/'; // relative path from filemanager folder to upload folder (with final /)
...
$access_keys = array('myPrivateKey', $akey);
