...
class Mainbanner extends Controller {
    ...
    function __construct() {
        ...
        $this->controller_header('mainbanner');
    }
    ...
    function add($postData = '') {
        ...
        $this->view->listCategory = $this->model->listCategory(146);
    ...
    function deletephoto($id='') {
        ...
        if(Session::get('admin_token') != $_GET['token']){
            Session::set('note_error', Lang::get('Token error!'));
        ...
        if($result){
            Session::set('note_success', Lang::get('Photo deleted!'));
            header('Location: ' . URL .$this->_menu.'/edit/'.$id);
            exit;
        } else {
            Session::set('note_success', Lang::get('Photo not deleted!'));
            header('Location: ' . URL .$this->_menu.'/edit/'.$id);
            exit;
        }
    }
