                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label><?= Lang::get('Photo') ?> * (<?=Lang::get('Crop image')?>: <?=photo_certificate_width.'x'.photo_certificate_height?>)</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="data_year" value="<?=(isset($this->item['year']))?$this->item['year']:''?>">
                            </div>
                        </div>
