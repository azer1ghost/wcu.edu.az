                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" value="<?=(isset($this->postData['name']))?$this->postData['name']:''?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><?= Lang::get('Login') ?></label>
                                <input type="text" class="form-control" name="login" value="<?=(isset($this->postData['login']))?$this->postData['login']:''?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group admin-role">
                                ...
                                <?php
                                $role = isset($this->postData['role']) ? $this->postData['role'] : array();
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="status" value="2" <?=(!isset($this->postData['status']) or (isset($this->postData['status']) && $this->postData['status'] != 1))?'checked':''?>><?=Lang::get('Active')?>
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="status" value="1" <?=(isset($this->postData['status']) && $this->postData['status'] == 1)?'checked':''?>><?=Lang::get('Passive')?>
                                </label>
                            </div>
                        </div>
