                ...
                <div class="panel-body">
                    <table width="100%" class="table table-hover" id="dataTablesNoSorting">
                        ...
                        <tr>
                            ...
                            <th width="200"><?= Lang::get('Category') ?></th>
                                ...
                                foreach ($menuData['parents'][$parentId] as $itemId) {
                                    ...
                                    $html .= '<tr>
                                                ...
                                                <td class="text-center">';
                                                    ...
                                                    $html .= '</td>
                                                    <td class="text-center"><a href="'.URL .'chair/edit/' . $menuData['items'][$itemId]['id'] . '"><span class="glyphicon glyphicon-pencil"></span></a></td>
                                                    ...
                                                    <td class="text-left">' . $menuData['items'][$itemId]['category'] . '</td>
