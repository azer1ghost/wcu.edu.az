                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <p>
                                    ...
                                    <span>Şəkillərin ölçüləri <?= photo_pages_width ?>x600 piksel olmalıdır.</span><br>
                                </p>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="data_link_<?=$key?>" value="<?=(isset($this->postData['data_link_'.$key]))?$this->postData['data_link_'.$key]:''?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label><?= Lang::get('Subtitle for menu') ?></label>
                                                    <input class="form-control" name="data_subtitle_<?=$key?>" value="<?=(isset($this->postData['data_subtitle_'.$key]))?$this->postData['data_subtitle_'.$key]:''?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group radio">
                                ...
                                <label class="radio-inline">
                                    <input type="checkbox" name="data_static_page" value="1"<?=(isset($this->postData['data_static_page']) && ($this->postData['data_static_page']>0))?' checked':''?>> <?= Lang::get('Static page') ?>
                                </label>
                                ...
                                <label class="radio-inline">
                                    <input type="checkbox" name="data_target" value="1"<?=(isset($this->postData['data_target']) && ($this->postData['data_target']>0))?' checked':''?>> <?= Lang::get('Target: _blank') ?>
                                </label>
                            </div>
                        </div>
