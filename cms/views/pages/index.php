                ...
                <div class="panel-body">
                    <table width="100%" class="table table-hover" id="dataTablesNoSorting">
                        ...
                        <tr>
                            ...
                            <th width="80"><?= Lang::get('Static page') ?></th>
                                ...
                                foreach ($menuData['parents'][$parentId] as $itemId) {
                                    ...
                                    $html .= '<tr>
                                                ...
                                                <td class="text-center">';
                                                    ...
                                                    $html .= '</td>
                                                    <td class="text-center"><a href="'.URL .'pages/edit/' . $menuData['items'][$itemId]['id'] . '"><span class="glyphicon glyphicon-pencil"></span></a></td>
                                                    ...
                                                    <td class="text-center">' .(($menuData['items'][$itemId]['static_page'] == 1) ? Lang::get('Static') : Lang::get('Dynamic')). '</td>
