                                ...
                                foreach (MFAdmin::$_langs as $key=>$value){
                                    ...
                                    <div role="tabpanel" class="tab-pane<?=($x==1)?' active':''?>" id="tab_<?=$key?>" data-lang="<?=$key?>">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label><?= Lang::get('Specialization') ?> *</label>
                                                    <input class="title form-control" name="data_specialization_<?=$key?>" value="<?=(isset($this->postData['data_specialization_'.$key]))?$this->postData['data_specialization_'.$key]:''?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
