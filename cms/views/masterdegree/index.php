                                ...
                                foreach ($menuData['parents'][$parentId] as $itemId) {
                                    ...
                                    $html .= '<tr>
                                                ...
                                                <td class="text-center">';
                                                    ...
                                                    $html .= '</td>
                                                    <td class="text-center"><a href="'.URL . 'masterdegree/edit/' . $menuData['items'][$itemId]['id'] . '"><span class="glyphicon glyphicon-pencil"></span></a></td>
                                                    ...
                                                    <td class="text-left"><label style="margin-left:'.$margin.';display:inline-block" for="checkBox' . $menuData['items'][$itemId]['id'] . '">' . $menuData['items'][$itemId]['title'].' - ' . $menuData['items'][$itemId]['specialization'].'</label></td>
