                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="data_category">
                                    ...
                                    foreach ($this->category as $key=>$value){
                                        $selected = ($key == $this->item['category'])?' selected':'';
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="data_index" value="<?=(isset($this->item['index']))?$this->item['index']:''?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?= Lang::get('Phone') ?></label>
                                <input class="form-control" name="data_phone" value="<?=(isset($this->item['phone']))?$this->item['phone']:''?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?= Lang::get('Fax') ?></label>
                                <input class="form-control" name="data_fax" value="<?=(isset($this->item['fax']))?$this->item['fax']:''?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?= Lang::get('E-mail') ?></label>
                                <input class="form-control" name="data_email" value="<?=(isset($this->item['email']))?$this->item['email']:''?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?= Lang::get('Map coordinate') ?> * (<?=Lang::get('Example')?>:40.344268, 49.844806)</label>
                                <input class="form-control" name="data_map" value="<?=(isset($this->item['map']))?$this->item['map']:''?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="data_address_<?= $key ?>" value="<?= (isset($this->item['address'][$key])) ? $this->item['address'][$key] : '' ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
