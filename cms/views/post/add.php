            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body confirm-panel">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <p>
                                    ...
                                    <span>Şəkillərin ölçüləri <?= photo_post_width ?>x600 piksel olmalıdır.</span><br>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><?= Lang::get('Post time') ?></label>
                                <div class="input-group date datetimepicker">
                                    <input class="form-control" name="post_time" value="<?=(isset($this->postData['post_time']))?$this->postData['post_time']:date('Y-m-d H:i:00')?>">
