...
class Masterdegree_Model extends Model {
    ...
    public function listItems() {
        ...
        $query = "SELECT P.`id`, P.`price`, P.`price_foreign`, P.`code`, T.`title`, T.`specialization`, T.`type`, T.`slug` 
    ...
    public function viewPost($id='') {
        ...
        $query = "SELECT P.`id`, T.`title`, T.`text`
                    ...
                    WHERE P.`id`=:id and P.`deleted` =:deleted and `category`=:category and P.`status` =:status
